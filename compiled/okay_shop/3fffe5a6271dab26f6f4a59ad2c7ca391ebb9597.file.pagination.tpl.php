<?php /* Smarty version Smarty-3.1.19-dev, created on 2020-05-12 21:59:04
         compiled from "/home/pro/www/workSpace/OkayCMS/design/okay_shop/html/pagination.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19485300895ebaf1f83a0231-15256434%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3fffe5a6271dab26f6f4a59ad2c7ca391ebb9597' => 
    array (
      0 => '/home/pro/www/workSpace/OkayCMS/design/okay_shop/html/pagination.tpl',
      1 => 1589308921,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19485300895ebaf1f83a0231-15256434',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ebaf1f8451c45_99332532',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ebaf1f8451c45_99332532')) {function content_5ebaf1f8451c45_99332532($_smarty_tpl) {?>
<?php if ($_smarty_tpl->tpl_vars['total_pages_num']->value>1) {?>
    <ul class="pagination<?php if ($_smarty_tpl->tpl_vars['ajax']->value) {?> fn_is_ajax<?php }?>">
        ...
        <?php if ($_smarty_tpl->tpl_vars['current_page_num']->value>1) {?>
            <li class="page_item">
                <a class="page_link" href="<?php if ($_smarty_tpl->tpl_vars['current_page_num']->value==2) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('page'=>null),$_smarty_tpl);?>
...
">
        ...
        <?php } else { ?>
            <li class="page_item">
                <a class="page_link" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('page'=>null),$_smarty_tpl);?>
">1</a>
            </li>
        <?php }?>
...
?>
            ...
            <?php if (($_smarty_tpl->tpl_vars['p']->value==$_smarty_tpl->tpl_vars['page_from']->value+1&&$_smarty_tpl->tpl_vars['p']->value!=2)||($_smarty_tpl->tpl_vars['p']->value==$_smarty_tpl->tpl_vars['page_to']->value&&$_smarty_tpl->tpl_vars['p']->value!=$_smarty_tpl->tpl_vars['total_pages_num']->value-1)) {?>
                <li class="page_item">
                    <a class="page_link" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('page'=>$_smarty_tpl->tpl_vars['p']->value),$_smarty_tpl);?>
">...</a>
                </li>
...
"><?php echo $_smarty_tpl->tpl_vars['p']->value;?>
        ...
        <?php } else { ?>
            <li class="page_item">
                <a class="page_link" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('page'=>$_smarty_tpl->tpl_vars['total_pages_num']->value),$_smarty_tpl);?>
"><?php echo $_smarty_tpl->tpl_vars['total_pages_num']->value;?>
        ...
        <li class="page_item">
            <a class="page_link" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('page'=>'all'),$_smarty_tpl);?>
" data-language="pagination_all"><?php echo $_smarty_tpl->tpl_vars['lang']->value->pagination_all;?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['current_page_num']->value<$_smarty_tpl->tpl_vars['total_pages_num']->value) {?>
            <li class="page_item">
                <a class="page_link" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('page'=>$_smarty_tpl->tpl_vars['current_page_num']->value+1),$_smarty_tpl);?>
